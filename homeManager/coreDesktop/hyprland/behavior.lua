...
hl.config({
  ...
  general = {
    ...
    resize_corner = "disable", -- force floating windows to use a specific corner when being resized (1-4 going clockwise from top left, 0 to disable)
  ...
  ecosystem = {
    no_update_news = true, -- disable hyprland support message
  },
